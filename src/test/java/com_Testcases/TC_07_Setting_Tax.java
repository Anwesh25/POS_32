...
import Page_Object.Setting_Tax;
import utilities.ExcelData;

public class TC_07_Setting_Tax extends BaseClass {
	
	public PLogin lg;
	public Setting_Tax St;
	
	@Test(dataProvider = "POS_cred")
	public void SetTax(String UName, String UPwd) throws InterruptedException {
